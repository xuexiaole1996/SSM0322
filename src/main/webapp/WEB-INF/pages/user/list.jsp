    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                <li> <a class="button border-main icon-plus-square-o" href="add"> 添加内容</a> </li>
                <li>搜索：</li>
                <li>首页
        ...
        <table class="table table-hover text-center">
            ...
            <volist name="list" id="vo">
                ...
                <tr>
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${user.isDel==1 }">有效</c:when>
                            <c:otherwise><span style="background: red;color:#FFF;padding: 5px;border-radius: 2px;">失效</span></c:otherwise>
                        </c:choose>
                    </td>
                    <td>
                        <div class="button-group">
                            <a class="button border-main" href="upd?loginId=${user.loginId}">
                                <span class="icon-edit"></span>
                                修改
                            </a>
                            <c:if test="${user.isDel==1}">
                                <a class="button border-red" href="javascript:void(0)" onclick="del(${user.id},1)">
                                    <span class="icon-trash-o"></span>
                                    删除
                                </a>
                            </c:if>
                            <c:if test="${user.isDel==0}">
                                <a class="button border-red" href="javascript:void(0)" onclick="del(${user.id},0)">
                                    <span class="icon-trash-o"></span>
                                    恢复
                                </a>
                            </c:if>
...
<script type="text/javascript">
    ...
    function del(id,flag){
        let msg=flag==1?"您确定要删除吗?":"您确定要恢复吗?";
        if(confirm(msg)){
